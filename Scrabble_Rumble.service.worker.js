...
/** @type {string} */
const CACHE_VERSION = '1765255489|8239180703';
/** @type {string} */
const CACHE_PREFIX = 'Scrabble_Rumble-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Scrabble_Rumble.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Scrabble_Rumble.html","Scrabble_Rumble.js","Scrabble_Rumble.offline.html","Scrabble_Rumble.icon.png","Scrabble_Rumble.apple-touch-icon.png","Scrabble_Rumble.audio.worklet.js","Scrabble_Rumble.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Scrabble_Rumble.wasm","Scrabble_Rumble.pck","Scrabble_Rumble.side.wasm","libgodot-solana-sdk.web.template_debug.wasm32.nothreads.wasm"];
